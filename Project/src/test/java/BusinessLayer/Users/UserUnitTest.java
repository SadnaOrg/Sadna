...
public class UserUnitTest {
    ...
    public void setUp() {
        ...
        when(u1.saveProducts(anyInt(), anyInt(), anyInt(),anyDouble(),anyString())).thenReturn(true);
    ...
    public void testSaveProductsFail() {
        when(u1.saveProducts(s1.getId(), p1.getID(), quantity, p1.getPrice(),"meow")).thenReturn(false);
        //saving a second time
        try {
            assertFalse(u1.saveProducts(s1.getId(), p1.getID(), quantity, p1.getPrice(),anyString()));
        }
