...
public class ProductByQuantityDiscount extends LeafPolicy{
    private int productID;
    private int quantity;
    private double priceForQuantity;

    public ProductByQuantityDiscount(SubscribedUserService service, int shopId, int parentId, int productID, int quantity, double priceForQuantity) {
    ...
    public String toString() {
        return "Product By Quantity Discount";
    }
}
