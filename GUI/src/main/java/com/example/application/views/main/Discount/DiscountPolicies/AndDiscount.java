...
public class AndDiscount extends CompositePolicy{
    public AndDiscount(SubscribedUserService service, int shopId, int parentId, Collection<DiscountPred> discountPreds, DiscountPolicy discounts) {
