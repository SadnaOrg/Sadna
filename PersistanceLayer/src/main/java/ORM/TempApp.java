...
public class TempApp {
    public static void main(String[] args) {
        ...
        SubscribedUser user1 = new SubscribedUser("user123", "pass123", "10/10/2020",false, true, null);
        SubscribedUser user2 = new SubscribedUser("user456", "pass123", "10/10/20", false, true, null);
